  ...
  return {
    featuredCollections: [
      ...
      },
      {
        ...
        badge: "TRENDING",
        description: "Limited edition digital collectibles secured on the blockchain. Own a piece of digital history.",
        image:
      ...
      },
      {
        ...
        title: "NFT Showcase",
        badge: "NEW",
        description: "Discover the latest NFT drops and exclusive digital assets from top creators.",
        image:
      ...
      },
      {
        ...
        badge: "POPULAR",
        description: "Join the exclusive club of Bored Ape owners and access unique perks and events.",
        image:
      ...
      },
      {
        ...
        title: "ApeCoin",
        badge: "HOT",
        description: "The official currency of the Bored Ape ecosystem. Stake, govern, and earn with ApeCoin.",
        image:
    ...
    categories: ["All", "Non-fiction", "Fiction", "Science Fiction", "Fantasy", "Crime", "Romance", "Mystery", "Other"],
    nftListings: [
      {
        id: 1,
        name: "Frogana",
