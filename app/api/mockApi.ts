...
export async function fetchUserBooks(category: "collected" | "sale"): Promise<Book[]> {
  await delay(1000)
  const books: Book[] = [
    {
      id: 1,
      ...
      author: "J.D. Salinger",
      description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo, recusandae.",
      coverImage:
