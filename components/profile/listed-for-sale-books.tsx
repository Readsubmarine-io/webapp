...
import { Download, Eye, MoreVertical, XCircle } from 'lucide-react'
        ...
        {books.map((book) => (
          ...
          >
            ...
            <CardContent className="p-4 flex flex-col w-2/3 relative">
              ...
              <div className="flex flex-col space-y-1">
                ...
                <ListPrice
                  ...
                  onPriceChange={(newPrice) => {
                    ...
                    console.log(
                      `Updated price for book ${book.id}: ${newPrice} SOL`,
                    )
                  }}
                />
                <span className="text-sm text-power-pump-text">
              ...
              <Badge className="bg-power-pump-button text-white mt-4 self-start">
                On Sale
              </Badge>
            </CardContent>
          </Card>
